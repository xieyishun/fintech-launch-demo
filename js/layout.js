...
const SIDEBAR_HTML = `
  <a href="../index.html" class="logo sidebar__logo">
    ...
    <span>Creator<span class="logo__text-accent">Bank</span></span>
  </a>
  ...
  <div class="sidebar__upgrade">
    ...
    <p>Higher loan limits and team accounts.</p>
    <a href="pricing.html" class="btn btn--sm btn--full">See plans</a>
  </div>
`;
